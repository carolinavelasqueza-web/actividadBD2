...
--- Estos procedimientos almacenados fueron creados con el objetivo de realizar de forma controlada las operaciones de inserción,
--- actualización, eliminación y consulta sobre las tablas principales de la base de datos.  
...
--- copia_actualizados_tablauu:** guarda los registros de operaciones `UPDATE`, indicando la tabla de origen, el tipo de operación,
--- la fecha y hora, así como los datos antiguos y los nuevos en formato JSON.  
...
## Conclusión  
---La base de datos `gestion_proyectos` se diseñó para administrar docentes y proyectos de manera eficiente mediante procedimientos almacenados (CRUD),
---una función para análisis estadístico y disparadores que permiten auditar automáticamente las operaciones realizadas.
--- Esto garantiza integridad, trazabilidad y control sobre la información, proporcionando un sistema robusto y confiable.  
